...
approvals:
  ...
  timeout: 3600                   # seconds to wait for user response (default: 3600 / 1 hour)
...
| `timeout` | `3600` | Seconds Hermes waits for an approval reply before timing out (one hour by default). |
